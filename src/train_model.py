...
def main():
    ...
    # Load data
    images, labels = load_data("data/healthy",target_size=(224,224))
    ...
    # Train
    model.train(train_images, train_labels, learning_rate=0.001, epochs=100,checkpoint_interval=10,checkpoint_dir="checkpoints")
    ...
    # Save final
    model.save("traind_models/leaf_model_refactored_v4_rgb_224i_256h_100epochs.pkl")
    print("Model saved.")
